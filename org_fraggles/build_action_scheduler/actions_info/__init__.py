...
from org_fraggles.build_action_scheduler.types import Action, ActionSha1
...
class ActionsInfo(BaseModel):
    ...
    _actions_by_sha1: Dict[ActionSha1, Action] | None = PrivateAttr(default=None)

    _actions_dependents: Dict[ActionSha1, Set[ActionSha1]] | None = PrivateAttr(
        default=None
    )

    _action_dependencies_count: Dict[ActionSha1, int] = PrivateAttr(
        default=defaultdict(int)
    )

    @property
    def actions_by_sha1(self) -> Dict[ActionSha1, Action]:
    ...
    @property
    def action_dependents(self) -> Dict[ActionSha1, Set[ActionSha1]]:
    ...
    @property
    def action_dependencies_count(self) -> Dict[ActionSha1, int]:
